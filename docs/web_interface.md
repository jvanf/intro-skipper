...
1. Download and extract the latest modified web interface from [GitHub actions](https://github.com/jvanf/intro-skipper/actions/workflows/container.yml)
...
1. Run the `ghcr.io/jvanf/jellyfin-intro-skipper` container just as you would any other Jellyfin container
